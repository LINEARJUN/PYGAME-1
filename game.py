...
class Game:
    ...
    def initialize(self):
        self.score = 0
        self.marisa = Marisa(image=MARISA_PATH, size=None, update_ms=60, pos=(150, 150), velocity=(2, 0))
        self.apples = []
        self.mushrooms = []
    ...
    def game(self):
        ...
        while True:
            ...
            for mushroom in self.mushrooms:
                # Physics
                dx, dy = self.marisa.pos[0] - mushroom.pos[0], self.marisa.pos[1] - mushroom.pos[1]
                distance = hypot(dx, dy)
                dx, dy = dx / distance, dy / distance # 벡터 정규화
                mushroom.velocity[0] = dx
                mushroom.velocity[1] = dy
